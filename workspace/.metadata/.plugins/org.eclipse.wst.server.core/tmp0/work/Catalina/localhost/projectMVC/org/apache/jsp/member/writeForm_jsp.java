 ...
 * Generated at: 2024-02-28 05:45:38 UTC
...
public final class writeForm_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("			<th>성별</th>\r\n");
      out.write("			<td>\r\n");
      out.write("				<input type=\"radio\" id=\"male\" name=\"gender\" value=\"0\" checked=\"checked\">\r\n");
      ...
      out.write("			\r\n");
      out.write("			if($('#id').val() == '')\r\n");
      out.write("				$('#idDiv').html('먼저 아이디를 입력하세요');\r\n");
      out.write("			else\r\n");
      out.write("				$.ajax({\r\n");
      out.write("					type: 'post',\r\n");
      out.write("					url: '/projectMVC/member/checkId.do',\r\n");
      out.write("					data: 'id=' + $('#id').val(), //서버로 보내는 데이터\r\n");
      out.write("					dataType: 'text', //서버로부터 오는 데이터 타입, 'exist' or 'non_exist'\r\n");
      out.write("					success: function(data){\r\n");
      out.write("						//alert(data.trim());\r\n");
      out.write("						\r\n");
      out.write("						if(data.trim() == 'exist')\r\n");
      out.write("							$('#idDiv').html('사용 불가능').css('color', 'red');\r\n");
