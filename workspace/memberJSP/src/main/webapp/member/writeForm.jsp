    ...
    <form name="writeform" method="post" action=""> 
        <table border="1" cellspacing="0" cellpadding="5">
            <tr>
                <th width="70">이름</th> 
                <td>
                    <input type="text" name="name" size="20" placeholder="이름 입력" />
            ...
            <tr>
       		...
       		<tr>
       			<th>재확인</th>
	    		<td>	
	    			<input type="password" name="repwd" size="25" />
            ...
            <tr>
                <th>주 소</th>
                <td>
                    <input type="text" name="zipcode" size="10" readyonly/>  <input type="button" onclick = "checkPost()" value="우편번호검색" ><br>
                	<input type="text" name="addr1" size="50" placeholder="주소" readyonly/><br>
